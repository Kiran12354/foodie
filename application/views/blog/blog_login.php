...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>My_assets/assets/bundles/bootstrap-social/bootstrap-social.css">
  <!-- Template CSS -->
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card-body">
                ...
                <?php endif;?>
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="text" class="form-control" name="captcha" tabindex="2" required="">
                    </div>
                  </div>
              ...
              Don't have an account? <a href="<?php echo base_url()?>create_blog">Create One</a>
            </div>
                </div>
              </div>
            </div>
