  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
            <li>
            <a href="<?php echo base_url()?>u_dashboard">
              <i class="nc-icon nc-bank"></i>
              <p>Dashboard</p>
            </a>
            </li>
          <li>
            <a href="<?php echo base_url()?>my_posts">
              <i class="nc-icon nc-paper"></i>
              <p>My Recipes</p>
            </a>
          </li>
          <li>
            <a href="<?php echo base_url()?>recipe_a">
              <i class="nc-icon nc-simple-add"></i>
              <p>ADD Recipes</p>
            </a>
          </li>
          <li>
            <a href="<?php echo base_url()?>usertrick">
              <i class="nc-icon nc-simple-add"></i>
              <p>Tips and Tricks</p>
            </a>
          </li>
          ...
          <li>
            <a href="<?php echo base_url()?>user_com">
              <i class="nc-icon nc-send"></i>
              <p>Complent Box</p>
            </a>
          </li>
          <li>
              <a href="<?php echo base_url()?>u_logout">
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <?php if($this->session->flashdata('success')) :?>
                ...
                <?php if($this->session->flashdata('complent')) :?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong><?php echo $this->session->flashdata('complent')?></strong> 
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
                </div>
